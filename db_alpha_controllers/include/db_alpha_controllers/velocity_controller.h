#ifndef DB_ALPHA_VELOCITY_CONTROLLER_H
#define DB_ALPHA_VELOCITY_CONTROLLER_H
...
// SYNC_WRITE_HANDLER
#define SYNC_WRITE_HANDLER_FOR_GOAL_VELOCITY 0
...
#endif //DB_ALPHA_VELOCITY_CONTROLLER_H
